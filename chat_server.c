...
"      } else {\n"
"        senderInput.value = '访客';\n"
"        localStorage.setItem('chat_username', '访客');\n"
"      }\n"
"    }\n"
"\n"
...
"      } else {\n"
"        localStorage.setItem('chat_username', '访客');\n"
"        document.getElementById('sender').value = '访客';\n"
"      }\n"
"    }\n"
"\n"
"    // ----- 历史消息 -----\n"
...
"        chatDiv.textContent = text || '✨ 暂无消息，快来发言吧！';\n"
